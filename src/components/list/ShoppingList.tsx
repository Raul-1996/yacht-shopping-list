...
export function ShoppingList() {
  ...
  const ShareButton = () => (
    <button
      onClick={shareList}
      className="w-full py-3 rounded-xl bg-ocean-50 dark:bg-ocean-900/20 text-ocean-600 dark:text-ocean-400 text-sm font-semibold flex items-center justify-center gap-2 active:bg-ocean-100 dark:active:bg-ocean-800/30 transition-colors"
    >
